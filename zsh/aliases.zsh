...
alias nxe='nix edit'
alias nxef='nix edit --file'
alias nxep='nix edit --file "<nixpkgs>"'
alias nxev='nix eval'
...
alias nxstqrt='nix-store --query --references --tree'
...
alias nxoe='nixops edit'
alias nxoed='nixops edit --deployment'
